            ...
            @foreach ($positions as $position)
                <tr>
                    ...
                    <td class="px-6 py-3 flex gap-4">
                        <a href="{{route('dashboard.positions.show',$position->id)}}" class="flex items-center space-x-2 text-neutral-400">
                            <div>
                        ...
                        <a href="{{route('dashboard.positions.edit',$position->id)}}" class="flex items-center space-x-2 text-yellow-400">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-3">
                        ...
                        <form action="{{route('dashboard.positions.destroy',$position->id)}}" method="POST">
                            @csrf
                            @method('delete')
